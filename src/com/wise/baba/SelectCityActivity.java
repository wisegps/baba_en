...
//						getString(R.string.dialog_title), getResources()
//								.getString(R.string.city_info_get));
...
//			tv_select_city_title.setText(R.string.hot_city);
...
//						+ cityData.getCity(), Toast.LENGTH_LONG).show();
//		// 释放内存
//		cityDatas.clear();
//		filterCityDatas.clear();
//		hotDatas.clear();
...
//		cityData.setFirst_letter(getResources().getString(R.string.hot_city));
//		cityDatas.add(0, cityData);
//
//		CityData cityData1 = new CityData();
//		cityData1.setType(1);
//		cityData1.setCity(getResources().getString(R.string.hot_city));
//		cityData1.setProvince("12312312312");
//		cityData1.setFirst_letter(getResources().getString(R.string.hot_city));

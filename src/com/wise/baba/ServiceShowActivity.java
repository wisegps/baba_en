...
//				long arg3) {
//			startActivity(new Intent(ServiceShowActivity.this,
//					ServiceShowInfoActivity.class));
//		}
//	};
//
//	private void ShowMenuPop(View auchor) {
//		LayoutInflater mLayoutInflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
//		View popunwindwow = mLayoutInflater.inflate(R.layout.activity_more,
//				null);
//		PopupWindow mPopupWindow = new PopupWindow(popunwindwow, screenWidth,
...
//			serviceData.setName(getResources().getString(R.string.app_name));
//			serviceData.setType(getResources().getString(R.string.wash_car));
...
//			ViewHolder holder;
//			if (convertView == null) {
//				convertView = mInflater.inflate(R.layout.item_service_specific,
//						null);
...
//			holder.tv_distance.setText(serviceDatas.get(position).getDistance()
//					+ "KM");
//			return convertView;
//		}
//

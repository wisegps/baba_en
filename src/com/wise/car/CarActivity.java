...
public class CarActivity extends Activity {
		...
		try {
			...
			if (jsonObject.getString("status_code").equals("0")) {
				...
				Toast.makeText(CarActivity.this,
						R.string.remove_binding_success, Toast.LENGTH_SHORT)
						.show();
	...
	private void jsonDelete(String str) {
		try {
			JSONObject jsonObject = new JSONObject(str);
			if (jsonObject.getString("status_code").equals("0")) {
				Toast.makeText(CarActivity.this, R.string.delete_success,
	...
	class CarAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			holder.tv_del.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (app.isTest) {
						Toast.makeText(CarActivity.this, R.string.no_function,
								Toast.LENGTH_SHORT).show();
						return;
					}
					index = position;

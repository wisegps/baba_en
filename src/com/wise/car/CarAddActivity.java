...
public class CarAddActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// LinearLayout btn_choose = (LinearLayout)
		// findViewById(R.id.btn_choose);
		// btn_choose.setOnClickListener(onClickListener);
		// choose_car_province = (TextView)
		// findViewById(R.id.choose_car_province);
	...
	OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.iv_add:
				if (app.isTest) {
					Toast.makeText(CarAddActivity.this, R.string.no_function,
			...
			if (jsonObject.getString("status_code").equals("0")) {
				...
				if (fastTrack) {
					...
					Toast.makeText(CarAddActivity.this,
							R.string.add_car_success, Toast.LENGTH_SHORT)
							.show();
					setResult(3);
				}
				finish();
			} else {
				Toast.makeText(CarAddActivity.this, R.string.add_faild,
						Toast.LENGTH_SHORT).show();
			}
	...
	private void addCar() {
		...
		if (nick_name.equals("")) {
			Toast.makeText(CarAddActivity.this, R.string.car_name_null,
					Toast.LENGTH_SHORT).show();
			return;
		}
		if (car_brand == null || car_brand.equals("")) {
			Toast.makeText(CarAddActivity.this, R.string.car_model_null,
					Toast.LENGTH_SHORT).show();
			return;
		}

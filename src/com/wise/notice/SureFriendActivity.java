...
//					holder.tv_status.setText(getResources().getString(
//							R.string.wait_add));
...
//		myDialog = ProgressDialog.show(SureFriendActivity.this, getResources()
//				.getString(R.string.note),
//				getResources().getString(R.string.accepting));
//		myDialog.setCancelable(true);
//		String url = Constant.BaseUrl + "customer/" + app.cust_id
//				+ "/auth_friend_request?auth_code=" + app.auth_code;
//		List<NameValuePair> params = new ArrayList<NameValuePair>();
//		params.add(new BasicNameValuePair("friend_id", String
//				.valueOf(friend_id)));
//		params.add(new BasicNameValuePair("status", "1"));
//		new NetThread.postDataThread(handler, url, params, sure_add_friend,
//				position).start();
...
//				newFriendAdapter.notifyDataSetChanged();
//			} else {
//				Toast.makeText(SureFriendActivity.this,
//						R.string.add_friend_faild, Toast.LENGTH_SHORT).show();
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
//			Toast.makeText(SureFriendActivity.this, R.string.add_friend_faild,
...
//		public void run() {
//			super.run();
//			Bitmap bitmap = GetSystem.getBitmapFromURL(friendDatas
//					.get(position).getLogo());
//			if (bitmap != null) {
//				GetSystem.saveImageSD(
//						bitmap,
//						Constant.userIconPath,
//						GetSystem.getM5DEndo(friendDatas.get(position)
//								.getLogo()) + ".png", 100);
//			}

...
//		tv_title.setText(getResources().getString(R.string.update_remind));
//
...
//		switch (type) {
//		case 0:
//			tv_before_note.setText(getResources()
//					.getString(R.string.remind_now));
//			remind_way = "0";
//			setWhite();
//			tv_before0.setBackgroundResource(R.drawable.bg_qianlan);
//			break;
//		case 1:
//			tv_before_note.setText(getResources().getString(
//					R.string.remind_oneday));
//			remind_way = "1";
//			setWhite();
...
//			case R.id.iv_ok:
//				if (app.isTest) {
//					Toast.makeText(CarRemindUpdateActivity.this,
//							R.string.no_function, Toast.LENGTH_SHORT).show();
//					return;
//				}
//				save();
//				break;
...
//						Toast.makeText(CarRemindUpdateActivity.this,
//								R.string.update_remind_success,
...
//		tv_remind_time.setText(getResources().getString(R.string.date)
//				+ remind_time);

...
//				sb.append(getResources().getString(R.string.place_two));
...
//						getResources().getString(R.string.place), url);
//			}
//		});
...
//			String url;
//			if (Type == 3) {// 违章不需要经纬度
//				url = Constant.BaseUrl + "location?auth_code=" + app.auth_code
//						+ "&city=" + URLEncoder.encode(LocationCity, "UTF-8")
//						+ "&type=" + Type + "&cust_id=" + app.cust_id;
//			} else {
//				url = Constant.BaseUrl + "location?auth_code=" + app.auth_code
//						+ "&city=" + URLEncoder.encode(LocationCity, "UTF-8")
//						+ "&type=" + Type + "&cust_id=" + app.cust_id + "&lat="
//						+ app.Lat + "&lon=" + app.Lon;
//			}

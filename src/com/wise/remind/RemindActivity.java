...
//			case R.id.bt_edit:
//				if (app.isTest) {
//					Toast.makeText(RemindActivity.this, R.string.no_function,
...
//						.setMessage(R.string.delete_remind)
...
//						"/mnt/sdcard/Picture.png", 0, 0, getResources()
...
//					getResources().getString(R.string.replacement_title));

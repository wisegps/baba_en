...
//				+ "/reminder?auth_code=" + app.auth_code;
//		new Thread(new NetThread.GetDataThread(handler, url, get_remind))
//				.start();
//	}
//
...
//					String title = getResources().getString(R.string.distance)
//							+ getCarName(remindData.getObj_id())
//							+ Constant.items_note_type[remindData
//									.getRemind_type()];
//					tv_name.setText(title);
//					int count_time = GetSystem.isTimeOut(remindData
//							.getRemind_time());
//					if (count_time > 0) {
...
//					} else {
//						tv_date.setText(getResources().getString(
//								R.string.overdue));
//						tv_date.setTextColor(getResources().getColor(
//								R.color.pink));
...
//				break;
//			case R.id.iv_add:
//				Intent intent1 = new Intent(RemindListActivity.this,
...
//						.inflate(R.layout.item_remind, null);
//				holder = new ViewHolder();
//				holder.tv_remind_type = (TextView) convertView
//						.findViewById(R.id.tv_remind_type);
//				holder.tv_obj_name = (TextView) convertView
//						.findViewById(R.id.tv_obj_name);
//				holder.tv_remind_time = (TextView) convertView
//						.findViewById(R.id.tv_remind_time);
//				holder.tv_date = (TextView) convertView
//						.findViewById(R.id.tv_date);
//				holder.tv_day = (TextView) convertView
//						.findViewById(R.id.tv_day);
//				holder.tv_remind_mileage = (TextView) convertView
//						.findViewById(R.id.tv_remind_mileage);
//				holder.tv_mileage = (TextView) convertView
//						.findViewById(R.id.tv_mileage);
//				holder.tv_mileage_unit = (TextView) convertView
//						.findViewById(R.id.tv_mileage_unit);
...
//			holder.tv_remind_type.setText(Constant.items_note_type[remindData
//					.getRemind_type()]);
...
//				holder.tv_day.setText(getResources()
//						.getString(R.string.overdue));
//				holder.tv_day.setTextColor(getResources()
...
//				holder.tv_day.setText(getResources().getString(R.string.day));
//				holder.tv_day.setTextColor(getResources()
//						.getColor(R.color.navy));
//				if (remindDatas.get(arg0).getRemind_type() == 2) {
//					// 保养里程提醒
//					holder.tv_remind_mileage.setText(remindDatas.get(arg0)
//							.getCur_mileage() + "KM");
...
//					if ((remindDatas.get(arg0).getMileages() - remindDatas.get(
//							arg0).getCur_mileage()) > 0) {
//						holder.tv_mileage.setText(String.valueOf(remindDatas
//								.get(arg0).getMileages()
//								- remindDatas.get(arg0).getCur_mileage()));
//					} else {
...
//			}
//			holder.iv_icon
//					.setBackgroundResource(Constant.items_note_type_image[remindDatas
//							.get(arg0).getRemind_type()]);
//			return convertView;
//		}
//
//		private class ViewHolder {
//			TextView tv_remind_type, tv_obj_name, tv_remind_time, tv_date,
//					tv_day, tv_remind_mileage, tv_mileage, tv_mileage_unit;
//			ImageView iv_icon;
//		}
//	}
//

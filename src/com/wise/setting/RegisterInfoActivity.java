...
public class RegisterInfoActivity extends Activity implements TagAliasCallback {
	...
	private void Save() {
		...
		if (cust_name.equals("")) {
			Toast.makeText(RegisterInfoActivity.this, R.string.nickname_null,
		...
		try {
			...
			if (!json.getBoolean("exist")) {
				...
				Toast.makeText(RegisterInfoActivity.this,
						R.string.nickname_exist, Toast.LENGTH_SHORT).show();
			}
	...
	private void jsonSave(String str) {
		try {
			...
			if (status_code.equals("0")) {
				...
				Toast.makeText(RegisterInfoActivity.this,
						R.string.regist_faild, Toast.LENGTH_SHORT).show();
			}
		} catch (JSONException e) {
			e.printStackTrace();
		}

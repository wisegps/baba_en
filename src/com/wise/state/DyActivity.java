...
public class DyActivity extends Activity {
	...
	private void getData() {
		String url = Constant.BaseUrl + "device/" + device_id
				+ "/obd_data?auth_code=" + app.auth_code + "&type=" + type + "&lang=en";
	...
	private void jsonData(String result) {
		try {
			...
			if ((type == 2 || type == 5) & long_term_value == 0) {
				tv_lt_dpdy.setText(getString(R.string.no_detection_data));
				tv_if_lt_dpdy_err
						.setText(getString(R.string.no_detection_data));
				...
				if (if_lt_err) {
					tv_if_lt_dpdy_err
							.setText(getString(R.string.state_abnormal));
					tv_if_lt_dpdy_err.setTextColor(getResources().getColor(
							R.color.yellow));
				} else {
					tv_if_lt_dpdy_err.setText(getString(R.string.state_good));
					tv_if_lt_dpdy_err.setTextColor(getResources().getColor(
							R.color.blue));
				}
			}
			...
			if ((type == 2 || type == 5) & last_trip_value == 0) {
				tv_dpdy.setText(getString(R.string.no_detection_data));
				tv_if_dpdy_err.setText(getString(R.string.no_detection_data));
				...
				if (if_err) {
					tv_if_dpdy_err.setText(getString(R.string.state_abnormal));
					tv_if_dpdy_err.setTextColor(getResources().getColor(
							R.color.yellow));
				} else {
					tv_if_dpdy_err.setText(getString(R.string.state_good));
					tv_if_dpdy_err.setTextColor(getResources().getColor(
							R.color.blue));
				}
			}
			...
			if ((type == 2 || type == 5) & last_trip_value == 0) {
				tv_real_dpdy.setText(getString(R.string.no_detection_data));
				tv_if_real_dpdy.setText(getString(R.string.no_detection_data));
				...
				if (if_rl_err) {
					tv_if_real_dpdy.setText(getString(R.string.state_abnormal));
					tv_if_real_dpdy.setTextColor(getResources().getColor(
							R.color.yellow));
				} else {
					tv_if_real_dpdy.setText(getString(R.string.state_good));
					tv_if_real_dpdy.setTextColor(getResources().getColor(
							R.color.blue));
				}
			}
			...
			shareView.loadUrl(url+"?lang=en");//背景知识的url 

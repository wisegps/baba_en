...
//			dialog.setMessage(R.string.is_add_car);
...
//				trafficViews.get(index).getRl_Note()
//						.setVisibility(View.VISIBLE);
//				trafficViews.get(index).getTv_note()
//						.setText(getString(R.string.no_traffic_violations));
//				trafficViews.get(index).getLl_info().setVisibility(View.GONE);
//			} else {
//				trafficViews.get(index).getRl_Note().setVisibility(View.GONE);
//				trafficViews.get(index).getLl_info()
...
//			tv_total_fine.setText(getString(R.string.no_traffic_violations));
//			// 读取当前城市的数据
//			if (i == index_car) {
//				GetTraffic();
//			}
...
//							String city_code = jsonObject3
//									.getString("city_code"); // 城市编码
...
//														.getTv_note()
//														.setText(
//																getString(R.string.all_engine_number));
//												trafficViews
//														.get(index_car)
//														.getLl_wait_show()
//														.setVisibility(
...
//														.getTv_note()
//														.setText(
//																getString(R.string.engine_number)
//																		+ engineno
...
//														.getTv_note()
//														.setText(
//																getString(R.string.all_chassis_number));
//												trafficViews
//														.get(index_car)
//														.getLl_wait_show()
//														.setVisibility(
...
//														.getTv_note()
//														.setText(
//																getString(R.string.chassis_number)
//																		+ frameno
//																		+ getString(R.string.position));
//												trafficViews
//														.get(index_car)
...
//				holder.tv_status.setText(getString(R.string.untreated));
//				holder.tv_status.setTextColor(getResources().getColor(
//						R.color.red));
//			} else {
//				holder.tv_status.setText(getString(R.string.deal_with));
//				holder.tv_status.setTextColor(getResources().getColor(
...
//					sb.append(getString(R.string.illegal_two));
//					sb.append(trafficData.getDate().substring(5, 16));
//					sb.append(" " + Car_name);
//					sb.append(getString(R.string.at)
//							+ trafficData.getLocation()
//							+ getString(R.string.happen_illegal));
//					sb.append(getString(R.string.illegal_content)
//							+ trafficData.getAction());
//					sb.append(getString(R.string.points)
//							+ trafficData.getScore());
//					sb.append(getString(R.string.fine) + trafficData.getFine()
//							+ getString(R.string.number));
//					GetSystem.share(TrafficActivity.this, sb.toString(), "", 0,
//							0, getString(R.string.illegal), "");
//				}
//			});
...
//					intent.putExtra("Title", getString(R.string.car_illegal));
...
//			List<CityData> chooseCityDatas = (List<CityData>) data
//					.getSerializableExtra("cityDatas");
//			if (chooseCityDatas.size() == 0) {
//				// 没有选择违章城市
//				trafficViews.get(index_car).getRl_Note()
//						.setVisibility(View.VISIBLE);
//				trafficViews.get(index_car).getLl_info()
//						.setVisibility(View.GONE);
//				trafficViews.get(index_car).getTv_note()
//						.setText(getString(R.string.illegal_city_null));
//				trafficViews.get(index_car).getLl_wait_show()
//						.setVisibility(View.GONE);
//			} else {
//				CarData carData = app.carDatas.get(index_car);
//				// 违章信息保存
...
//				// 保存
//				String url = Constant.BaseUrl + "vehicle/"
//						+ carData.getObj_id() + "/vio_city?auth_code="
//						+ app.auth_code;
//				List<NameValuePair> params = new ArrayList<NameValuePair>();
//				params.add(new BasicNameValuePair("vio_citys",
//						jsonList(chooseCityDatas)));
//				new NetThread.putDataThread(handler, url, params, update_city)
//						.start();
//
...
//									} else {
//										if (engineno == 1) {// 全部
//											if (carData.getEngine_no() == null
//													|| carData.getEngine_no()
//															.length() == 0) {
//												trafficView.setType(2);
//												trafficViews
//														.get(index_car)
...
//					+ app.carDatas.get(index_car).getObj_id()
//					+ "/violation?auth_code=" + app.auth_code;
//			new NetThread.GetDataThread(handler, url, frist_traffic, index_car)
//					.start();
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//		} else {
//			try {
//				JSONObject jsonObj = new JSONObject(baseDatas.get(0)
//						.getContent());
//				jsonTraffic = jsonObj.getJSONObject("result");
//			} catch (Exception e) {
//				e.printStackTrace();

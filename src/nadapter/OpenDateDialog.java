...
public class OpenDateDialog {
	...
	public static void ShowDate(Context context, final int index) {
		...
		View v = LayoutInflater.from(context)
				.inflate(R.layout.data_wheel, null);
		...
		// year
		year.setViewAdapter(new DateNumericAdapter(context, curYear - 80,
				curYear + 10, 0));
		...
		addHoldBuilder.setTitle(R.string.input_date);
		addHoldBuilder.setView(v);
		addHoldBuilder.setPositiveButton(R.string.determine,
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						String trueTime = (curYear - 80 + year.getCurrentItem())
								+ "-"
		...
		addHoldBuilder.setNegativeButton(R.string.cancel, null);
		addHoldBuilder.show();
	}
	...
	public static void SetCustomDateListener(
			OpenDateDialogListener openDateDialogListener) {
